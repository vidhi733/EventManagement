<x-main-layout>
    <div class="m-2 p-2 flex justify-between">
        <h3 class="mb-4 text-2xl font-bold text-gray-700 dark:text-gray-300">{{ $event->title }}</h3>
    ...
    <div class="mb-16 flex flex-wrap">
        <div class="mb-6 w-full shrink-0 grow-0 basis-auto lg:mb-0 lg:w-6/12 lg:pr-6">
            <div class="flex flex-col">
                ...
                @auth
                    <div class="flex space-x-2 p-4" x-data="{
                        ...
                        <button type="button" @click="onHandleLike"
                            class="text-white  focus:outline-none  font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 dark:bg-blue-600 "
                            :class="eventLike ? 'bg-red-700 dark:bg-red-700' : 'bg-slate-700 dark:bg-slate-700 '">
                        ...
                        <button type="button" @click="onHandleSavedEvent"
                            class="text-white focus:outline-none  font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 "
                            :class="savedEvent ? 'bg-yellow-700 dark:bg-yellow-700' : 'bg-slate-700 dark:bg-slate-700 '">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="w-3.5 h3.5 mr-2">
                                <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <button type="button" @click="onHandleAttending"
                            class="text-white focus:outline-none  font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 "
                            :class="attending ? 'bg-green-700 dark:bg-green-700' : 'bg-slate-700 dark:bg-slate-700 '">
                            Attending
                ...
                <div class="flex flex-col p-4">
                    <span class="text-gary-600 dark:text-gray-300 font-semibold text-xl">Host Info</span>
                    <div class="flex space-x-4 mt-6 bg-slate-200 dark:bg-gray-800 dark:text-gray-300 p-2 rounded-md">
                        <span>
        ...
        <div class="w-full shrink-0 grow-0 lg:w-6/12 lg:pl-6 bg-slate-200 dark:bg-gray-800 rounded-md pt-2 pr-6 pb-6">
            <p class="mb-6 text-md text-yellow-600 dark:text-neutral-300">
            ...
            @auth
                 <div
                    class="container d-flex justify-content-center align-items-center w-50 mt-6 bg-slate-200 dark:bg-gray-900 p-4 rounded-md">
                    <div>
                    ...
                    <div class="w-full">
                        @foreach ($event->comments()->latest()->get() as $comment)
                            <div class="w-full p-4 duration-500">
                                <div class="flex items-center rounded-lg bg-white dark:bg-gray-700 p-4 shadow-md ">
                                    <div>
                                        <div class="flex space-x-2">
                                            ...
                                            <h2 class="text-lg font-bold text-gray-900 dark:text-gray-300">{{ $comment->user->name }}</h2>
                                        </div>
